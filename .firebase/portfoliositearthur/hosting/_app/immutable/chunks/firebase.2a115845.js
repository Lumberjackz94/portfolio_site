import{d as ld,w as ni}from"./index.145e5b94.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd="storage";function _E(t,e,n){return t=$(t),z_(t,e,n)}function EE(t){return t=$(t),H_(t)}function IE(t,e){return t=$(t),Q_(t,e)}function X_(t=Fi(),e){t=$(t);const s=Zs(t,cd).getImmediate({identifier:e}),r=Mc("storage");return r&&J_(s,...r),s}function J_(t,e,n,s={}){Y_(t,e,n,s)}function Z_(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new na(n,s,r,e,bt)}function eE(){_t(new et(cd,Z_,"PUBLIC").setMultipleInstances(!0)),ke(Rc,Nc,""),ke(Rc,Nc,"esm2017")}eE();const tE={apiKey:"AIzaSyAlBuEPqzVUpVnOnJwnc1nAyqyz4bzkbSE",authDomain:"portfoliositearthur.firebaseapp.com",projectId:"portfoliositearthur",storageBucket:"portfoliositearthur.appspot.com",messagingSenderId:"992407474004",appId:"1:992407474004:web:bec80e070e5144002382c1",measurementId:"G-2GVHQ1BG3E"};Bc(tE);const nE=Ny(),cn=qw(),TE=X_();function sE(){let t;if(!cn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=ni(null);return{subscribe:n}}const{subscribe:e}=ni((cn==null?void 0:cn.currentUser)??null,n=>(t=Ov(cn,s=>{n(s)}),()=>t()));return{subscribe:e}}const rE=sE();function iE(t){let e;const n=ky(nE,t),{subscribe:s}=ni(null,r=>(e=jy(n,i=>{r(i.data()??null)}),()=>e()));return{subscribe:s,ref:n,id:n.id}}const SE=ld(rE,(t,e)=>{if(t)return iE(`users/${t.uid}`).subscribe(e);e(null)});export{Ke as G,gE as Q,cE as R,yE as W,aE as _,cn as a,vE as b,SE as c,TE as d,nE as e,pE as f,ky as g,EE as h,_E as i,hE as j,lE as k,uE as l,dE as m,mE as n,fE as o,IE as r,wE as s,rE as u};
